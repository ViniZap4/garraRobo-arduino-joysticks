...
// definindo as portas dos potenciometros(joystick)
#define pot1 A0
#define pot2 A1
#define pot3 A2
#define pot4 A3
...
// criando as variavies dos angulos de cada motor
int motor1,motor2,motor3,motor4;

// criando as varieveis para controle do mostrador - (monitor serial)
